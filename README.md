...
`A token is used to authenticate a user. A server sends a token on successful login, which can be used as Authorization to do take further actions, as well as stay logged in.`

- [ ] What steps can you take in your web apps to keep your data secure?

`The main one we've discussed this far is requiring a log-in to perform any sensitive operation. Surely we'll learn about more next unit too.`

- [ ] Describe how web servers work.

`They receive requests at their URL and respond based on the type of request and the endpoint used.`
